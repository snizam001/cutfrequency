...
make_option(c("-p", "--peakFile"), type="character", default=NA,help="If the number of the motifs are higher in the genome and do not have enough memory, then might be interested in exploring cut-frequency at only peaks. If yes then, provide peakFile in the bed format.", metavar="character"),
